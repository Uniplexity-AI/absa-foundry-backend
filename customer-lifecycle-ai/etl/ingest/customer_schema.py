...
CUSTOMER_FIELDS: tuple[CustomerField, ...] = (
    ...
    CustomerField(
        ...
        label="Mobile Number",
        dtype="string",
        format="phone number (free text, up to 32 chars)",
        max_length=32,
        example="+260971234567",
        notes="Customer's primary contact phone number.",
        aliases=("mobile_number", "mobilenumber", "mobile", "phone_number", "phonenumber", "phone", "cell", "cellphone"),
    ),
    CustomerField(
        name="next_of_kin_name",
        label="Next of Kin Name",
        dtype="string",
        format="free text, max 128 chars",
        max_length=128,
        example="Jane Curtis",
        notes="Name of the customer's next of kin.",
        aliases=("next_of_kin_name", "nok_name"),
    ),
    CustomerField(
        name="next_of_kin_relationship",
        label="Next of Kin Relationship",
        dtype="string",
        format="free text, max 64 chars",
        max_length=64,
        example="Spouse",
        notes="Relationship to the next of kin.",
        aliases=("next_of_kin_relationship", "nok_relationship", "nok_relation"),
    ),
    CustomerField(
        ...
        format="phone number (free text, up to 32 chars)",
        max_length=32,
        example="+260971234568",
        notes="Phone number of the next of kin.",
        aliases=("next_of_kin_phone", "nok_phone", "nok_mobile"),
    ),
    CustomerField(
        name="gender",
        label="Gender",
